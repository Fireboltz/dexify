          ...
          children: <Widget>[
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  color: DexifyAppTheme.nearlyDarkBlue.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      DexifyAppTheme.nearlyDarkBlue.withOpacity(0.2),
                      DexifyAppTheme.nearlyDarkBlue.withOpacity(0.5)
                    ],
            ...
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    colors: [
                      DexifyAppTheme.nearlyDarkBlue.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: new ScaleTransition(
                ...
                child: Container(
                  ...
                  height: 2,
                  decoration: BoxDecoration(
                    color: DexifyAppTheme.white.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: new Transform(
                ...
                child: Container(
                  ...
                  height: 4,
                  decoration: BoxDecoration(
                    color: DexifyAppTheme.white.withOpacity(
            ...
            Column(
              children: <Widget>[
                AspectRatio(
                  aspectRatio: 1,
                  child: Image.asset("assets/dexify/bottle.png"),
                ),
              ],
            )
          ],

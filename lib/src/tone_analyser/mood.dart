...
class _StepperBodyState extends State<StepperBody> {
      ...
      data: ThemeData(
        ...
        child: new Stepper(
          steps: <Step>[
            ...
            new Step(
                title:
                const Text('What are you planing to do for the rest of the day?'),
            ...
            new Step(
                title: const Text('Whatcha ben upto'),
                isActive: true,
                state: StepState.indexed,
                content: new TextFormField(
  ...
  void _submitDetails() {
    final FormState formState = _formKey.currentState;
      formState.save();
      getData(questions.question1+" "+questions.question2+" "+questions.question3+" "+questions.question4);
    }
  }
